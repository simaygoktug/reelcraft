...
export default function ReelCraftStudio() {
  ...
  const handleGenerate = () => {
    setLoading(true);
    setTimeout(() => {
      setCaption("🎬 When AI meets creativity, the result is viral magic!");
      setHashtags("#AIReels #ShortsGenerator #GoViral #ReelCraft");
      setLoading(false);
    }, 1500);
  };
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-2xl p-10">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-purple-100 p-4 rounded-2xl shadow-inner text-gray-800 text-sm">
            <label className="block text-xs font-semibold text-purple-800 mb-1">📝 Generated Caption</label>
          ...
          <div className="bg-orange-100 p-4 rounded-2xl shadow-inner text-gray-800 text-sm">
            <label className="block text-xs font-semibold text-orange-800 mb-1">🔥 Trending Hashtags</label>
